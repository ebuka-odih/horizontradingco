                ...
                <ul class="nav-main">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link "  href="{{ route('admin.deposits') }}">
                            <i class="nav-main-link-icon fa fa-arrow-alt-circle-down"></i>
                            <span class="nav-main-link-name">Deposits</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link "  href="">
                            <i class="nav-main-link-icon fa fa-arrow-alt-circle-up"></i>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link "  href="#">
                            <i class="nav-main-link-icon fa fa-arrow-alt-circle-up"></i>
                            <span class="nav-main-link-name">Purchased NFT</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link "  href="{{ route('admin.payment-wallet.index') }}">
                            <i class="nav-main-link-icon fa fa-wallet"></i>
                            <span class="nav-main-link-name">Payment Wallet</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link "  href="#">
                            <i class="nav-main-link-icon fa fa-money-bill-wave"></i>
                            <span class="nav-main-link-name">Fund Account</span>
                        </a>
                    </li>
